...
const CARRIER_DATA = [
  ...
  ['Employers', ['MI','OH','TX','GA','AZ','AL','TN','IN'], ['general','construction','manufacturing','trucking','contractors','retail','small_business'], 1, 9999, null, null, 36, 21, false, true, true, true, true, true, 0, 0, false, false, false, true, ['workers_comp'], 300, 5000, false, 24, 'Workers comp specialist. 46 states + DC. Small business focus. Pair with any auto quote for account rounding.', 'request'],
  ['Insur-Fi', ['MI','OH','TX','GA','AZ','AL','TN','IN'], ['contractors','manufacturing','wholesale','distribution','real_estate','landlord'], 1, 9999, null, null, 36, 21, false, true, true, false, true, true, 0, 0, false, false, false, true, ['general_liability','workers_comp','property','bop'], 400, 8000, false, 48, 'Boutique wholesale: artisan contractors, manufacturing, warehouse, distribution, habitational, lessor risk, large WC. NOT primary commercial auto.', 'request'],
  ['Hiscox', ['MI','OH','TX','GA','AZ','AL','TN','IN'], ['contractors','consultants','small_business','professional_services'], 1, 25, null, null, 36, 21, false, false, true, false, true, true, 0, 1, false, false, false, true, ['general_liability','professional_liability','bop','cyber'], 300, 3000, true, 2, 'Small business GL / professional liability / BOP / cyber. Instant bind. Up to $5M revenue. NOT commercial auto.', 'request'],
  ['RLI', ['MI','OH','TX','GA','AZ','AL','TN','IN'], ['contractors','construction'], 1, 100, null, null, 36, 21, false, false, true, false, true, true, 0, 0, false, false, false, true, ['general_liability','umbrella','inland_marine','surety'], 400, 5000, false, 48, 'Contrac Pac: artisan contractors GL + inland marine + BPP. A+ rated. Also umbrella and surety bonds.', 'request'],
  ['Cowbell Cyber', ['MI','OH','TX','GA','AZ','AL','TN','IN'], ['technology','healthcare','professional_services','general'], 1, 9999, null, null, null, 21, false, false, true, false, true, true, 0, 0, false, false, false, true, ['cyber','technology_e_o','professional_liability'], 500, 10000, true, 2, 'Cyber insurance specialist. NOT commercial auto. Standalone cyber + tech E&O. Good cross-sell on any qualified account.', 'request'],
  ['CrossCover', ['MI','OH','TX','GA','AZ','AL','TN','IN'], ['general','landlord','real_estate'], 1, 9999, null, null, null, 21, false, false, true, false, true, true, 0, 0, false, false, false, true, ['property'], 500, 8000, false, 48, 'E&S commercial property MGU. Property only — pair for account rounding on real estate / landlord risks.', 'request']
];
